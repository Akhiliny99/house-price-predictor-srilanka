...
def generate_pdf_report(prediction, range_low, range_high,
    ...
    story.append(Paragraph(
        ...
        f"&nbsp;|&nbsp; Student: Akhiliny Vijeyagumar "
        f"&nbsp;|&nbsp; Index: 20APSE4875",
    ...
    # Property Details + Investment Score
    prop_details = [
        ['Property Details', ''],
...
if predict_btn:
            ...
            <div style="margin-top:14px;">
                ...
                <div class="insight-row">
                    ...
                    <span class="insight-value"
                          style="color:{'#34d399' if prediction < mkt['avg'] else '#f59e0b'};">
    ...
    with fc3:
        ...
        <div class="feature-card">
            ...
            <div style="margin-top:10px;padding-top:10px;
                ...
                <div style="font-size:0.65rem;color:#7c6b9e;letter-spacing:1px;
    ...
    with res_col2:
        ...
        <div style="background:rgba(6,182,212,0.06);border:1px solid
                    rgba(6,182,212,0.2);border-radius:12px;
